...
/*
	...
	execute all provided test files. Given an array of n distinct integers, 
	...
	order, where k = (n + 1) / 2. You need to find the lexicographically smallest 
	...
	Note: You can modify at most three lines in the given code. You cannot 
	add or remove lines of code.
	To restore the original code, click on the icon to the right of the 
	language selector.

	Input Format:
	The first line contains t the number of test cases. The first line of each 
	test case contains an integer n, denoting the number of array elements. The 
	next line of the test case contains n elements of array a.

	Constraints:
	1 <= t <= 20
	1 <= n <= 10000 (n is always odd)
	1 <= a_i (sunscript) 10^9
