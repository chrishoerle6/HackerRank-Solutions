...
/*
	A teacher asks the class to open their books to a page number. A student 
	can either start turning pages from the front of the book or from the back 
	of the book. They always turn pages one at a time. When they open the book, 
	...
	a student wants to turn to page p, what is the minimum number of pages to turn? 
	...
	n = 5
	p = 3
	Ff the student wants to get to page 3, they open the book to page 1, flip 1
...
public static int pageCount(int n, int p) {
    int numPages = n / 2;
    int numPagesToTargetFromFront = p / 2;
    int numPagesToTargetFromBack = numPages - numPagesToTargetFromFront;
    
    return Math.min(numPagesToTargetFromFront, numPagesToTargetFromBack);
}