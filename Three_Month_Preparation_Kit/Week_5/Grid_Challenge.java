...
/*
	...
	elements within the same row can be rearranged. They cannot be moved to 
	a different row.
	...
	Each of the nexttsets of lines are described as follows:
	...
	This fulfills the condition since the rows 1, 2, ..., 5 and the columns 
