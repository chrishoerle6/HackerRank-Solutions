...
/*
	...
	first, and both players always play optimally.The rules of the game are 
	as follows:
	...
	n = 2
	m = 6
	There are 2 towers, each 6 units tall. Player1  has a choice of two moves:
	...
	it to 1. Then P2 reduces the remaining tower to a height of 1. As both 
	towers now have height 1, P1 cannot make a move so P2 is the winner.
	In the second test case, there is only one tower of height 4. P1 can 
	reduce it to a height of either 1 or 2. P1 chooses 1 as both players 
	always choose optimally. Because P2 has no possible move, P1 wins.
*/
